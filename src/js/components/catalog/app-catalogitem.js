    ...
    render:function() {
        ...
        return (
            <div className="col-sm-3" style={itemStyle}>
                ...
                <img src={this.props.item.thumbnailUrl} alt="" width="150" height="150" />
                <p>{this.props.item.description}</p>
                <p>${this.props.item.price} <span className="text-success">{this.props.item.inCart && '(' + this.props.item.qty + ' in cart)'}</span></p>
